...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1 첫번째 문자의 아스키코드 : " + str1.codePointAt(0)); //W : 87
		System.out.println("str2 세번째 문자의 아스키코드 : " + str2.codePointAt(2)); //야 : 50556
		...
		/*
		 10] indexOf() : 문자열에서 특정 문자열의시작인덱스를 
