...
public class E06PrePostFixOperator {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.printf("num1 = %d, num2 = %d, num3 = %d %n%n", num1, num2, num3);// 최종결과 7, 8, 7
		...
		*/
		...
		System.out.println("후위증가/감소식");
		System.out.printf("num1 = %d, num2 = %d, num3 = %d", num1, num2, num3);// 최종결과 7, 7, 8
