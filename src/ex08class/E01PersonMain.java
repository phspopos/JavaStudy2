...
/*
 클래스 선언시 class 예약어를 상용한다. 클래스명의 첫글자는 반드시
 대문자로 기술해야 한다. 또한 public 접근지정자는 하나의 Java 파일에
...
class Person{
	...
	/*
	 멤버메서드 : 클래스에서 객채의 동작(행위)를 표현한다. 클래스
...
public class E01PersonMain {
	...
	public static void main(String[] args) {
		...
		/*
		 Person 클래스를 통해 인스턴스르 생성한다ㅏ. 생성시 할당된
