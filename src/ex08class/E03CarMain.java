...
/*
 이 예제에서는 Human 클래스를 별도의 파일로 작성하였다. 동일한 패키지에
 정의되었다면 컴파일러는 해당 클래스를 찾아 즉시 인스턴스로 만들수 있다.
...
class Car{
	...
	void showCarInfo() {
		...
		//모델명은 Car의 멤버변수이므로 즉시 상용할 수 있다.
		System.out.printf("모델명 : %s\n", carModel);
		/*
		 소유주는 owenr 인스턴스에 정의된 멤버메서드를 호출하여 
		 상태를 출력할수 있다. 
		 */
		owner.showState();
	}
...
public class E03CarMain {
	...
	public static void main(String[] args) {
		/*
		  자동차1 객체 생성 : 매개변수가 없는 초기화 메서드를호출하므로
		  '람보르기니'로 초기화 된다.
		...
		/*
		  ...
		  직접 접근하여 인스턴스를 초기화한다. 이 경우 인스턴스르
		...
		/*
		  자동차4 객체 생성 : 인스턴스 생성만 하고 초기화하지 않은 상태로 출력을 시도하므로
		  예외가 발생한다.
		 */
		Car car4 = new Car();
		//car4.showCarInfo();
